...
#ifndef INCLUDEGUARD_SERIALLOOPBACK_H
#define INCLUDEGUARD_SERIALLOOPBACK_H

#include <string>

#include "serialport.h"

class CSerialLoopback : public CSerial {
public:
	CSerialLoopback(Bitu id, CommandLine* cmd);
	virtual ~CSerialLoopback();
	...
	Bitu lastUsedTick = 0;
	std::string filename;
	uint8_t loopbackByte = 0;
};

#endif // INCLUDEGUARD_SERIALLOOPBACK_H
